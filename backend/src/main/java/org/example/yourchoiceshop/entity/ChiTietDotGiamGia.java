...
public class ChiTietDotGiamGia extends BaseStatusEntity {
    ...
    @Column(name = "so_luong_ap_dung") private Integer soLuongApDung;
    @Column(name = "gia_tri_giam_rieng") private BigDecimal giaTriGiamRieng;
    @Column(name = "so_tien_toi_da_giam_rieng") private BigDecimal soTienToiDaGiamRieng;
